...
//   return (
//     <div className="max-w-7xl mx-auto py-24 md:pt-36 overflow-hidden z-50  ">
...
//         className="space-y-6 border border-border rounded-lg p-6 bg-slate-100 dark:bg-[#020617]  antialiased "
//       >
